          ...
          <div style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: "10px", padding: "1rem" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div>
                ...
                <p style={{ margin: 0, color: "#475569" }}>{data.tenant.slug}</p>
              </div>
          ...
          <div style={{ display: "grid", gap: "1rem" }}>
            <div style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: "10px", padding: "1rem" }}>
              ...
              <div style={{ maxHeight: "180px", overflow: "auto" }}>
                {(data.errors || []).map((e) => (
                  <div key={e.id} style={{ padding: "0.4rem 0", borderBottom: "1px solid #e2e8f0" }}>
                    <div style={{ fontWeight: 600 }}>{e.status_code}</div>
                    <div style={{ color: "#475569", fontSize: "0.9rem" }}>
                      {e.method} {e.path}
                    </div>
                    <div style={{ color: "#ef4444", fontSize: "0.9rem" }}>{e.error_message}</div>
                  </div>
                ))}
            ...
            <div style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: "10px", padding: "1rem" }}>
              ...
              <div style={{ maxHeight: "180px", overflow: "auto" }}>
                {(data.feedback || []).map((f) => (
                  <div key={f.id} style={{ padding: "0.4rem 0", borderBottom: "1px solid #e2e8f0" }}>
                    <div style={{ fontWeight: 600, textTransform: "capitalize" }}>{f.category}</div>
                    <div style={{ color: "#0f172a" }}>{f.message}</div>
            ...
            <div style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: "10px", padding: "1rem" }}>
              ...
              <div style={{ display: "grid", gap: "0.4rem", color: "#0f172a" }}>
                ...
                <div style={{ marginTop: "0.5rem", display: "grid", gap: "0.25rem", color: "#475569" }}>
